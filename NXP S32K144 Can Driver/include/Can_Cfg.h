...
#if(CAN_CFG_AR_RELEASE_MAJOR_VERSION != STD_AR_RELEASE_MAJOR_VERSION)\
	||(CAN_CFG_AR_RELEASE_MINOR_VERSION != STD_AR_RELEASE_MINOR_VERSION)\
	||(CAN_CFG_AR_RELEASE_REVISION_VERSION != STD_AR_RELEASE_REVISION_VERSION)
...
#define CAN_0_BASE_ADDRESS  (uint32)(0x40024000U)
#define CAN_1_BASE_ADDRESS  (uint32)(0x40025000U)
#define CAN_2_BASE_ADDRESS  (uint32)(0x4002B000U)
