...
/* This function initialize the DIO as user configration (DIO_cfg.h" */
void DIO_Init()
{
...
/* This function changes the direction of a given PIN (0 to 31) */
void DIO_SetPinDir(U8 LOC_U8_PinNum,U8 LOC_U8_PinDir)
{
	...
	else if ( LOC_U8_PinDir != 1 || LOC_U8_PinDir != 0 ) 
	{
		/* Error */
		return;
	}
...
void DIO_SetPinValue(U8 LOC_U8_PinNum,U8 LOC_U8_Pinvalue)
{
	...
	else if ( LOC_U8_Pinvalue != 1 || LOC_U8_Pinvalue != 0 ) 
	{
		/* Error */
		return;
	}
